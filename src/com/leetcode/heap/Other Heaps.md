...
- is a data structure that consist of a collection of trees which follow the Min Heap, or Max Heap property

- designed to improve the asymptotic running time of the Dijkstra's algorithm

- Characteristics:

  - a node can have more than 2 children or no children at all

  - it has more efficient heap operations than that of binomial heaps and binary heaps

  - it was called Fibonacci heap because the trees are constructed in a way such that a tree of order `n` has at least `f(n+2)` nodes in it.  The `f(n+2)` is the `(n+2)th` Fibonacci number.

    ![Fibonacci Heap](https://cdn.programiz.com/cdn/farfuture/WgeXgB_o4_0qX5Iv2msbC1zcYn1s3Ay7ypgfac4CmMo/mtime:1585306008/sites/tutorial2program/files/fibonacci-heap.png)

### Properties of a Fibonacci Heap

1. It is a set of **min heap-**[**ordered**](https://cs.lmu.edu/~ray/notes/orderedtrees/) trees. (i.e. The parent is always smaller than the children.)

2. A pointer is maintained at the minimum element node.

3. It consists of a set of marked nodes. (Decrease key operation)

4. The trees within a Fibonacci heap are unordered but [rooted](https://mathworld.wolfram.com/RootedTree.html).
...
![Fibonacci Heap Structure](https://cdn.programiz.com/cdn/farfuture/VsG7KIKpPe37TYtVHP2XoeYpbBwXlOEvSK7QYGNSyAo/mtime:1585306002/sites/tutorial2program/files/fibonacci-heap-structure.png)
...
This process makes use of [decrease-key](https://www.programiz.com/dsa/decrease-key-and-delete-node-from-a-fibonacci-heap#decrease) and [extract-min](https://www.programiz.com/dsa/fibonacci-heap) operations. The following steps are followed for deleting a node.
...
### Best implementation of Fibonacci Heap:
